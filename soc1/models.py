...
class Profile(models.Model):
    ...
    gender = models.CharField(max_length=15, verbose_name=u'Пол', choices=GENDER_CHOICES)
    relationship = models.CharField(max_length=15, verbose_name=u'Статус отношений', choices=REL_CHOICES, default='none')
